...
_encrypt_1024 :: proc(ctx: ^Threefish1024, input, output: []u64) {
	b0 := input[0];
    b1 := input[1];
    b2 := input[2];
    b3 := input[3];
    ...
    k0 := ctx.expandedKey[0];
    k1 := ctx.expandedKey[1];
    k2 := ctx.expandedKey[2];
    k3 := ctx.expandedKey[3];
    k4 := ctx.expandedKey[4];
    k5 := ctx.expandedKey[5];
    k6 := ctx.expandedKey[6];
    k7 := ctx.expandedKey[7];

    k8 := ctx.expandedKey[8];
    k9 := ctx.expandedKey[9];
    k10 := ctx.expandedKey[10];
    k11 := ctx.expandedKey[11];
    k12 := ctx.expandedKey[12];
    k13 := ctx.expandedKey[13];
    k14 := ctx.expandedKey[14];
    k15 := ctx.expandedKey[15];
    k16 := ctx.expandedKey[16];

    t0 := ctx.expandedTweak[0];
    t1 := ctx.expandedTweak[1];
    t2 := ctx.expandedTweak[2];
...
_decrypt_1024 :: proc(ctx: ^Threefish1024, input, output: []u64) {
	b0 := input[0];
    b1 := input[1];
    b2 := input[2];
    b3 := input[3];

...
MD5_FF :: #force_inline proc "contextless" (a, b, c, d, m: u32, s: int, t: u32) -> u32 {
    return b + util.ROTL32(a + MD5_F(b, c, d) + m + t, s); 
}

MD5_GG :: #force_inline proc "contextless" (a, b, c, d, m: u32, s: int, t: u32) -> u32 {
    return b + util.ROTL32(a + MD5_G(b, c, d) + m + t, s);
}

MD5_HH :: #force_inline proc "contextless" (a, b, c, d, m: u32, s: int, t: u32) -> u32 {
    return b + util.ROTL32(a + MD5_H(b, c, d) + m + t, s);
}

MD5_II :: #force_inline proc "contextless" (a, b, c, d, m: u32, s: int, t: u32) -> u32 {
    return b + util.ROTL32(a + MD5_I(b, c, d) + m + t, s);
}

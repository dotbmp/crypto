...
test_blake_224 :: proc() -> bool {
    ...
    for i := 0; i < 4; i += 1 {
        ...
        msg = blake224TestVectors[i].str;
        hash = blake224TestVectors[i].hash;
        out = crypto.blake224(([]byte)(msg));
...
test_blake_256 :: proc() -> bool {
    ...
    for i := 0; i < 4; i += 1 {
        ...
        msg = blake256TestVectors[i].str;
        hash = blake256TestVectors[i].hash;
        out = crypto.blake256(([]byte)(msg));
        outStr = hex.encode(out[:]);
...
test_blake_384 :: proc() -> bool {
    ...
    for i := 0; i < 4; i += 1 {
        ...
        msg = blake384TestVectors[i].str;
        hash = blake384TestVectors[i].hash;
        out = crypto.blake384(([]byte)(msg));
        outStr = hex.encode(out[:]);
...
test_blake_512 :: proc() -> bool {
    ...
    for i := 0; i < 4; i += 1 {
        ...
        msg = blake512TestVectors[i].str;
        hash = blake512TestVectors[i].hash;
        out = crypto.blake512(([]byte)(msg));
        outStr = hex.encode(out[:]);
...
main :: proc() {
    ...
    if(test_blake_224()) {
        fmt.println("Tests for BLAKE-224 passed.");
    }

    if(test_blake_256()) {
        fmt.println("Tests for BLAKE-256 passed.");
    }

    if(test_blake_384()) {
        fmt.println("Tests for BLAKE-384 passed.");
    }

    if(test_blake_512()) {
        fmt.println("Tests for BLAKE-512 passed.");
    }
}